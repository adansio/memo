...
function test
    ...
    mapa_NLOS=imread('edifc.jpg');
    
    UPr = -71;                               
    mapa_LOS = llenar(mapa_LOS,dim1,dim2);
...
function atenuacion = linea (NLOS, apx, apy, ptox, ptoy)
    ...
    if (apx-ptox) == 0
        if ptoy > apy 
            ...
            while ptoy > apy 
                if flag == 0 && NLOS(ptoy,ptox) == 0
                    atenuacion = atenuacion + LOSS;
                    flag = 1;
                elseif flag == 1 && NLOS(ptoy,ptox) ~= 0
                    flag=0;
                end
                ptoy=ptoy-1;
            end
